...
<body>
    ...
    $consulta = "call pagar_reserva('" . $_POST["id"] . "')";
  ...
  <strong>ERROR!</strong> Ha habido un error, la reserva no se ha podido pagar.
  </div>";
    } else {
        echo "<div class=\"alertsucc\">
  <span class=\"closebtn\" onclick=\"this.parentElement.style.display='none';\">&times;</span> 
  <strong>CORRECTO!</strong> Se ha pagado correctamente.
  </div>";
    }
